/**
 * Carrier Webhook Ingestion API Route
 * Path: src/app/api/shipping/tracking/webhook/route.ts
 *
 * Ingests courier delivery tracking webhooks from Kerry, Flash, and Central Express.
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Unhandled error in carrier tracking webhook:', error);
    return NextResponse.json(
