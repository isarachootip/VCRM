/**
 * Supervisor Reporting Summary REST Endpoint (Supports /api/reports/summary)
 * Path: src/app/api/reports/summary/route.ts
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('[Report Summary] Error generating report summary:', error);
