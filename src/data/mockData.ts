    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: 'item-5',
            name: 'Retail Chain Omnichannel POS',
            companyName: 'Mega Retail Group',
            contactPerson: 'Waraporn Chokdee',
            contactEmail: 'waraporn@megaretail.mock',
    ...
    groups: [
      {
        ...
        items: [
          {
            id: 'del-1',
            name: 'Siam Paragon Luxury Furniture Drop-off',
            companyName: 'Siam Retail Corp',
            contactPerson: 'K. Somkiat (Warehouse Mgr)',
            contactEmail: 'somkiat@siamretail.co.th',
            ...
            address: 'Siam Paragon Loading Bay B, Pathum Wan, Bangkok',
